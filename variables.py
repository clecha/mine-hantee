...
IMAGES_DICT = {'titre': pygame.image.load('images/ecran_titre/titre.png'),
			   ...
			   'niveau_IA':pygame.image.load('images/init_jeu/niveau_IA.png'),
			   'niveau1':pygame.image.load('images/init_jeu/niveau1.png'),
			   'niveau1hover':pygame.image.load('images/init_jeu/niveau1hover.png'),
			   'niveau2':pygame.image.load('images/init_jeu/niveau2.png'),
			   'niveau2hover':pygame.image.load('images/init_jeu/niveau2hover.png'),
			   'niveau3':pygame.image.load('images/init_jeu/niveau3.png'),
			   'niveau3hover':pygame.image.load('images/init_jeu/niveau3hover.png'),
