...
IMAGES_DICT = {'titre': pygame.image.load('images/ecran_titre/titre.png'),
             ...
             'carte2_bright' : pygame.image.load('images/cartes/type2_bright.png').convert(),
             'carte3_bright' : pygame.image.load('images/cartes/type3_bright.png').convert(),
             'carte1_hover' : pygame.image.load('images/cartes/type1_hover.png').convert_alpha(),
             'carte2_hover' : pygame.image.load('images/cartes/type2_hover.png').convert(),
             'carte3_hover' : pygame.image.load('images/cartes/type3_hover.png').convert(),	
